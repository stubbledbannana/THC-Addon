...
import com.thcaddons.utils.ILivingEntity;
...
public class NoJumpDelay extends Module {
    ...
    public NoJumpDelay() {
        // Uses the THCAddon category constant as requested
        super(THCAddon.CATEGORY, "no-jump-delay", "Removes the delay between jumps.");
    }
