package com.thcaddons.modules;
import meteordevelopment.meteorclient.utils.player.FindItemResult;
import com.thcaddons.THCAddon;
import com.thcaddons.mixin.accessor.PlayerInventoryAccessor;
import com.thcaddons.mixin.accessor.UpdateSelectedSlotS2CPacketAccessor;
...
import com.thcaddons.utils.RotationUtils;
import com.thcaddons.utils.PlacementUtils;
import com.thcaddons.utils.InventoryManager;
import com.thcaddons.utils.THCUtils;
...
public class Phase extends Module {
    ...
    public Phase() {
        super(THCAddon.CATEGORY, "phase", "Allows player to phase through solid blocks using ender pearls.");
    ...
    @EventHandler
    private void onPushOutOfBlocks(THCUtils event) {
        if (isActive()) {
            event.cancel();
        }
    }
